...
namespace DanfePDF
{
    internal class DanfePagina
    {
        ...
        public void DesenharImpressoEm()
        {
            string textImpressoEm = $"Impresso em {DateTime.Now}";
            Gfx.DrawString(textImpressoEm, RetanguloCreditos, Danfe.EstiloPadrao.CriarFonteItalico(6), AlinhamentoHorizontal.Esquerda);
        }
